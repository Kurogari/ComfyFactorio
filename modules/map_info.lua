...
local map_info = {
	...
	main_caption_color = {r=230, g=120, b=70},
	sub_caption = "Insert Sub Caption",
	sub_caption_color = {r=230, g=50, b=120},
	text = [[
...
local create_map_intro = (function (player, frame)
	...
	local t0 = frame.add {type = "table", column_count = 2}
	local cat = t0.add({type = "sprite-button", name = "cat", sprite = "file/CatGearSpaceCatDerp.png", enabled = false})
	cat.style.width = 256
	cat.style.height = 256
	cat.style.top_margin = 50
	local t = t0.add {type = "table", column_count = 1}
	...
	l_2.style.minimal_width = 500
	l_2.style.horizontal_align = "center"
	l_2.style.vertical_align = "center"

	local scroll_pane = t.add { type = "scroll-pane", name = "scroll_pane", direction = "vertical", horizontal_scroll_policy = "never", vertical_scroll_policy = "auto"}
